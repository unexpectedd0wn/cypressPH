...
describe('Substitution Tab states for UD prefered', () => {
    ...
    */
    ...
    //             // StockNote = `Out of Stock ${Ballina},  Out of Stock ${Dublin} `;
    ...
    //             // StockNote = ' Back In Stock Ballina ';
    //             StockNote = BSock_Message(Ballina);
    //             ExpectedDelivery = 'Same Day';
    ...
    //             // StockNote = 'Out of Stock Ballina,  Back In Stock Dublin ';
    //             StockNote = OOS_BSock_Message(Ballina, Dublin);
    ...
    //             // StockNote = ` Back In Stock ${Dublin} `;
    //             StockNote = BSock_Message(Dublin);
    //             ExpectedDelivery = 'Next Day';
    //             cy.SubstitutionState_type3(StockNote, preferedDescription, ExpectedDelivery)
    //         });
    //     });
    ...
    //             StockNote = BSock_Message(Limerick);
    //             ExpectedDelivery = 'Same Day';
    //             cy.SubstitutionState_type3(StockNote, preferedDescription, ExpectedDelivery)
    //         });
    //     });
    ...
    //                 // StockNote = 'Out of Stock Limerick,  Back In Stock Dublin ';
    //                 StockNote = OOS_BSock_Message(Limerick, Dublin);
    //                 preferedExpectedDelivery = 'Next Day';
    //                 nextbestExpectedDelivery = 'Same Day'
    //                 cy.SubstitutionState_type4(StockNote, preferedDescription, nextBestDescription, preferedExpectedDelivery, nextbestExpectedDelivery)
    //             });
    ...
    //             // StockNote = ` Out of Stock ${Ballina} `;
...
function OOS_BSock_Message(depotM, depotC) {
