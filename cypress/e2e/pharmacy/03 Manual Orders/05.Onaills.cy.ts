...
const wholesaler = Wholesalers.ONEILLS.Name;
...
describe('Manual Orders: United Drug', () => {
    ...
    it('Order 1 O’NEILLS Item | Brokered Ethical', () => {
    ...
    it('Order 1 O’NEILLS Item | Brokered OTC', () => {
    ...
    //Need to thing how to devide ULM cases, here O'Naills ULM!
