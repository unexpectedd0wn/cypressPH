...
describe('Substitution Tab states for UD items where prefered is set', () => {
    ...
    */
    ...
    before(() => {
        ...
        sql.addItemToSubstitutionTab(preferedId, pharmacyId, IPUcode, currentDateTime);
        cy.clearAllCookies();
    });
    ...
    context('Ballina -> Dublin', () => {
        ...
        it.only('01.01', () => {
            ...
            */
            ...
            sql.updateUDStockProductStock(0, 0, 0, preferedId);
        ...
        it('01.04', () => {
            ...
            +---------------+-------------------+------------------+------------------+-------------------+
            */
            sql.updateUDStockProductStock(1, 0, 0, preferedId);
            sql.updateUDStockProductStock(0, 0, 0, nextBestId);
            sql.updatePharmacy(useCutOff.yes, cutOffTime.before, localaDepot.Ballina, cutoffDepot.Dublin, pharmacyId);
        ...
        it('01.05', () => {
            ...
            +---------------+-------------------+------------------+------------------+-------------------+
            */
            sql.updateUDStockProductStock(0, 1, 0, preferedId);
            sql.updateUDStockProductStock(1, 0, 0, nextBestId);
            sql.updatePharmacy(useCutOff.yes, cutOffTime.before, localaDepot.Ballina, cutoffDepot.Dublin, pharmacyId);
    ...
    context('Limerick -> Dublin', () => {
        ...
        it('03.04', () => {
            ...
            +---------------+-------------------+------------------+------------------+-------------------+
            */
            sql.updateUDStockProductStock(0, 0, 1, preferedId);
            sql.updateUDStockProductStock(0, 0, 0, nextBestId);
            sql.updatePharmacy(useCutOff.yes, cutOffTime.before, localaDepot.Limerick, cutoffDepot.Dublin, pharmacyId);
        ...
        it('03.07', () => {
            ...
            */
            sql.updateUDStockProductStock(0, 1, 0, preferedId);
            sql.updateUDStockProductStock(0, 0, 0, nextBestId);
            sql.updatePharmacy(useCutOff.yes, cutOffTime.after, localaDepot.Limerick, cutoffDepot.Dublin, pharmacyId);
    ...
    context('Ballina -> Ballina', () => {
        ...
        it('04.01', () => {
            ...
            +---------------+-------------------+------------------+------------------+-------------------+
            */
            sql.updatePharmacy(useCutOff.yes, cutOffTime.before, localaDepot.Ballina, cutoffDepot.Ballina, pharmacyId);
            sql.updateUDStockProductStock(0, 0, 0, preferedId);
            sql.updateUDStockProductStock(1, 0, 0, nextBestId);
        ...
        it('04.07', () => {
            ...
            */
            sql.updateUDStockProductStock(1, 0, 0, preferedId);
            sql.updateUDStockProductStock(0, 0, 0, nextBestId);
            sql.updatePharmacy(useCutOff.yes, cutOffTime.after, localaDepot.Ballina, cutoffDepot.Ballina, pharmacyId);
