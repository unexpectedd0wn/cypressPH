...
checkCartCard(wholeslaer ,expectedDelivery, description, packsize, packtype, netprice, discount){
    
    //leftSummaryCard
    this.elements.summaryCard().should('exist').and('be.visible');
    this.elements.summaryCardWholesalerName().should('include.text', wholeslaer).and('be.visible');
    ...
    this.elements.cartCardTitle().should('include.text', wholeslaer).and('be.visible');
